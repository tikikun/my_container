FROM debian:buster-slim AS clang16_image
...
RUN echo "deb https://apt.llvm.org/buster llvm-toolchain-buster-16 main" \
    ...
    apt-get -qq update && \
    apt-get install -qqy -t llvm-toolchain-buster-16 clang-16 clangd-16 clang-tidy-16 clang-format-16 lld-16 libc++-16-dev libc++abi-16-dev && \
